  ...
  return (
    <svg className='county-map' version="1.1"  xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 1920 1080">
        <g id="Vientiane-counties">
            <polygon className="county" points="287.3,451.28 253.85,417.84 296.42,233.6 264.19,191.64 283.04,171.58 347.49,211.1 370.6,206.85 
            ...
            <polygon className="county" points="596.19,302.31 637.03,288.42 711.71,330.89 769.48,298.66 850.96,338.79 873.46,396.86 901.43,416.01 
            ...
            <path className="county" d="M925.2,674.74c1.01-1.14,56.85,79.19,40.48,77.93c-17.02-1.31-151.2,0-151.2,0l-112.41-70.01l29.71-20.39
                L925.2,674.74z"/>
            <path className="county" d="M982.7,640.57l50.27,61.12c0.51,0.24,1.18,1.28,0.3,2.03c-6.59,5.65-20.27,39.86-24.34,43.21
                c-3.33,2.74-18.96,18.6-23.8,24.79c-10.4,13.34-18.34-28.73-18.34-28.73s-21.59-45-41.59-68.26l42.5,2.74L982.7,640.57z"/>
            <path className="county" d="M1011.23,743.29l14.03,25.59l23.92,2.03l3.24,47.43l-11.35,24.32h-57.97l2.03-70.94c0,0,5.51-6.28,11.45-13.23
                c7.74-9.04,16.3-19.1,15.21-17.02C1009.87,745.16,1011.23,743.29,1011.23,743.29z"/>
            <polygon className="county" points="953.11,457.36 975.9,434.05 1006.01,445.71 1040.67,422.7 1034.99,379.19 1067.42,360.28 
            ...
            <path className="county" d="M1360.1,310.82l77.02,52.7l21.08-13.78l34.05,85.94l187.28,17.84v17.03c0,0-62.43,70.42-78.64,55.48
            ...
            <polygon className="county" points="1041.07,842.66 1098.23,842.66 1194.84,735.13 1159.85,690.24 1068.23,674.84 1033.57,702 
                1011.79,741.48 1025.27,768.88 1049.18,770.91 1052.42,818.34 	"/>
            <polygon className="county" points="983.11,842.66 955.95,889.68 960.41,923.33 1063.77,974 1108.77,954.14 1101.07,921.3 1087.69,889.68 
